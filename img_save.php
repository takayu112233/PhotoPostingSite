...
function photo_save($file,$user_id)
{ 
  ...
  $file_path = "./upload_img/" . $_SESSION["user_id"] . "_" . $hased_string . "." . $extension;
  ...
  if($extension == "png" or $extension == "PNG"){
    $jpg_file_path = "./upload_img/" . $_SESSION["user_id"] . "_" . $hased_string . ".jpg";
    png_to_jpg($file_path,$jpg_file_path);
    $file_path = $jpg_file_path;
    $resize_file_path = "./upload_img/resize/" . $_SESSION["user_id"] . "_" . $hased_string . ".jpg";
    $database_file_path = $_SESSION["user_id"] . "_" . $hased_string . ".jpg";
  }
  ...
  insert_database($_SESSION["user_id"], $database_file_path, $_POST["shop_id"], $_POST["comment"]);
